...
between speedFac and compression ratio.
*/
...
*) some features needed to make a conformant PNG-EditorState might be still missing.
...
If you want no color conversion to be done (e.g. for speedFac or control):
