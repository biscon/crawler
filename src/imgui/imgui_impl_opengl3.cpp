...
//  2021-08-23: OpenGL: Fixed ES 3.0 geometryShader ("#version 300 es") use normal precision floats to avoid wobbly rendering at HD resolutions.
//  2021-08-19: OpenGL: Embed and use our own minimal GL loader (imgui_impl_opengl3_loader.h), removing requirement and support for third-party loader.
//  2021-06-29: Reorganized backend to pull data from a single structure to facilitate usage with multiple-contexts (all g_XXXX access changed to bd->XXXX).
//  2021-06-25: OpenGL: Use OES_vertex_array extension on Emscripten + backup/restore current state.
//  2021-06-21: OpenGL: Destroy individual vertex/fragment geometryShader objects right after they are linked into the main geometryShader.
...
//  2019-05-29: OpenGL: Desktop GL only: Added support for large geometryMesh (64K+ vertices), enable ImGuiBackendFlags_RendererHasVtxOffset flag.
...
//  2018-01-07: OpenGL: Changed GLSL geometryShader version from 330 to 150.
...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    CheckShader(vert_handle, "vertex geometryShader");

    const GLchar* fragment_shader_with_version[2] = { bd->GlslVersionString, fragment_shader };
    GLuint frag_handle = glCreateShader(GL_FRAGMENT_SHADER);
    glShaderSource(frag_handle, 2, fragment_shader_with_version, nullptr);
    glCompileShader(frag_handle);
    CheckShader(frag_handle, "fragment geometryShader");
    ...
    CheckProgram(bd->ShaderHandle, "geometryShader program");
