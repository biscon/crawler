...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::Checkbox("With CellSide Preview", &side_preview);
        if (side_preview)
        {
            ImGui::SameLine();
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Resizable, fixed"))
    {
        ...
        // FIXME-TABLE: Providing a stretch-on-create would make sense especially for tables which don't have saved settings
        HelpMarker(
